...
void setup() {
    ...
    Serial.println(
        F("Warning: this example overwrites the UID of your UID changeable "
          "card, use with care!"));
...
void loop() {
    ...
    // the entire process when idle. And if present, select one.
    ...
    //    Serial.println(F("This sample only works with MIFARE Classic
    //    cards.")); return;
    //  }
